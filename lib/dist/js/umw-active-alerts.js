...
var UmwActiveAlerts = /*#__PURE__*/function () {
  ...
  return _createClass(UmwActiveAlerts, [{
    ...
    value: function handleFetchError(error) {
      ...
      if (typeof error.json === "function") {
        error.json().then(function (jsonError) {
          _this.log("Json error from API");
          _this.log(jsonError);
        })["catch"](function (genericError) {
          _this.log("Generic error from API");
    ...
    value: function doAlert(type) {
      ...
      var queryUrl = url + '?' + this.getQueryString();
      ...
      fetch(queryUrl, {
        ...
        _this2.log(data);
        _this2.insertAlert(data, type);
      })["catch"](function (error) {
        _this2.handleFetchError(error);
      });
    }
  }, {
    key: "insertAlert",
    ...
    value: function doGlobalEmergency() {
